...
if ($action == 'delete') {
    ...
    foreach ($userdomain as $key => $value) {
        ...
        if (grr_sql_count($res) != 0) {
            for ($i = 0; ($row = grr_sql_row($res, $i)); $i++) {
				/* un passage par champs additionnel */
                $html .= "<tr>\n";
                ...
                /* type list choiy multiple checkbox */
                $html .= '<option value="checkbox" ';
                if ($row[2] == 'checkbox') {
                    $html .= ' selected="selected"';
                }
                $html .= ' >'.get_vocab('type_checkbox')."</option>\n";
                /* type numeric */
                ...
                $html .= "/></td>\n";
                if ($row[2] == 'list'/* || $row[2] == 'checkbox' */) {
                    $html .= '<td colspan="2">&nbsp;</td>';
                    $html .= '</tr><tr><td colspan="7">';
                    $html .= get_vocab('Liste des champs').get_vocab('deux_points');
                ...
                $html .= '<td><form class="deleteOverloadField" method="post" action="admin_overload.php">'."\n";
