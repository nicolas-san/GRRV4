 ...
 * @param bool $display défaut à true, si c'est true on lance le rendu du template, sinon on retourne juste le tableau de vars pour TWIG
 * @param bool $admin défaut à true, si c'est true et que $display est à true, ça lance le render du tempalet printHeaderAdmin, si $display est à false, ce param n'est pas pris en compte
 */
